...
class CashierAccountsScreen extends StatefulWidget {
  ...
  @override
  State<CashierAccountsScreen> createState() => _CashierAccountsScreenState();
}

class _CashierAccountsScreenState extends State<CashierAccountsScreen> {
  ...
  String _formatStaffId(int index) {
    return 'CA${index.toString().padLeft(3, '0')}';
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Danh sách Cashier'),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (staff.isEmpty) {
                  return const Center(
                    child: Text('No cashier found', style: TextStyle(fontSize: 16)),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final cashier = staff[index];
                    return _buildStaffRow(cashier, index + 1);
                  },
                );
              },
            ),
  ...
  void _showDetailDialog(BuildContext context, QueryDocumentSnapshot staff) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Chi tiết Cashier'),
